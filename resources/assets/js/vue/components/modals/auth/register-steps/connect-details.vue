...
export default {
	...
	mounted() {
		...
		if (this.tempUser) {
			this.account.individual.first_name = this.tempUser.first_name;
			this.account.individual.last_name = this.tempUser.last_name;
			this.account.individual.email = this.tempUser.email;
			this.account.individual.phone = this.tempUser.phone ? this.tempUser.phone : '';
